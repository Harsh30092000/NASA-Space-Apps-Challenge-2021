...
export class GetLocation extends Component {
    ...
    render() {
        ...
        <img src={SAC} className="sac" alt="SAC" />
            ...
            ${this.state.lat},${this.state.lng}&zoom=17&size=1504x500&sensor=false&markers=color:red%7C${this.state.lat},${this.state.lng}&key=AIzaSyBZKgOw0iHBsgviKcnRqih4p2iPfOz4Jd8`} alt="map" className="getData__map" />
                            </div>
                            :
                            <div className="map">
